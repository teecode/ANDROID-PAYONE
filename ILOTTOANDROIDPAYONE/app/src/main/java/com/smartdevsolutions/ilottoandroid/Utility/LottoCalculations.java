...
public class LottoCalculations {
    ...
    public BetInput DoCalculation(BetInput Bet) {
        if (!Bet.getNap().equals("AG") && !Bet.getNap().equals("AGS")) {
            int bet1count = Bet.getBet1().size();
            int r = Bet.getMin_no_of_balls();
    ...
    int againstRange(List<String>  bet1, List<String> bet2)
    {
        try {
    ...
    int checkCollisonAgainstRange(int x, List<String> bet2)
    {
    ...
    int againstSingles(List<String>  bet1, List<String> bet2)
    {
        try {
            int collisioncount = 0;
            int countbet1 = bet1.size();
    ...
    int checkCollisonAgainstSingles(int x, List<String> bet2)
    {
        int ret = 0;
        ;
        int input = x;
        ...
        {
            int elementin2 = Integer.parseInt(bet2.get(i));
            if (input == elementin2)
            {
                return 1;
            }
