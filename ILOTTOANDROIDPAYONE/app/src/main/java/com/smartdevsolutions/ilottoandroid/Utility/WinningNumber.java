...
public class WinningNumber {
    ...
    public String getWinningNumbers() {
            return ""+String.format("%02d" , winning_ball1) + "-" + String.format("%02d" , winning_ball2) + "-"+ String.format("%02d" , winning_ball3) + "-"+ String.format("%02d" , winning_ball4) + "-"+ String.format("%02d" , winning_ball1) ;
    }
