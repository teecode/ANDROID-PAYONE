...
public class FundTransferFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        shopbalanceTextView =     (TextView)  rootView.findViewById(R.id.fundshopbal);
       ...
       // shopbalanceTextView.setText("SHOP BAL :"+cust.getShopwalletbalance());
...
//            }
    ...
    public class CashierFundingTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private DeviceResource devOutput ;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
               ...
               // SI.setCustomerposting(devOutput.getSerial());
                SI.setAmount(amount);
...
//                    shopbalanceTextView.setText("SHOP BAL :"+custOutput.getShopwalletbalance());
